...
public class SignCalendar extends ViewFlipper implements
  ...
  public static final int COLOR_TX_OTHER_MONTH_DAY = Color.parseColor("#efefef"); // 其他月日历数字颜色
  public static final int COLOR_TX_THIS_DAY = Color.parseColor("#2fd2d0"); // 当天日历数字颜色
